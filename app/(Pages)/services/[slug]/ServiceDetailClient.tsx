        ...
        <section className="section-md border-t border-[var(--cq-linen)] bg-[var(--cq-parchment-mid)]">
          <div className="container-content">
            <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-12 items-center">
              <div>
                <span className="badge-label mb-4">THE CONCEPT</span>
        ...
        <section className="section-md border-t border-[var(--cq-linen)] bg-[var(--cq-parchment)]">
          <div className="container-content">
            <div className="flex flex-col gap-2 mb-10 text-center md:text-left">
              <span className="badge-label self-center md:self-start">WHAT IS INCLUDED</span>
        ...
        <section className="section-md border-t border-[var(--cq-linen)] bg-[var(--cq-parchment-mid)]">
          <div className="container-content">
            <div className="flex flex-col gap-2 mb-10 text-center">
              <span className="badge-label self-center">OUR APPROACH</span>
