  ...
  return (
    <>
      ...
      <PageHero
        ...
        title={
          <>
            Let&apos;s Build Something <em style={{ fontStyle: "italic", opacity: 0.9 }}>Together</em>
          </>
        }
        subtitle="Get in touch for a free content strategy consultation. We reply to all inquiries within 24 hours."
        breadcrumb={[
          { name: "Home", path: "/" },
      ...
      <main className="section-md border-t border-[var(--cq-linen)] bg-[var(--cq-cream)]">
        <div className="container-content grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-12 items-start">
          {/* Left Column: Contact details card */}
          <div className="bg-[var(--cq-parchment)] border border-[var(--cq-linen)] rounded-[var(--radius-xl)] p-8 md:p-10 shadow-sm flex flex-col gap-8">
            <div className="flex flex-col items-start gap-4">
              ...
              <h2 className="font-display text-2.5xl md:text-3xl text-[var(--cq-ink)] leading-tight font-normal">
                Let&apos;s Talk About Your Content
              </h2>
              <p className="text-sm font-light text-[var(--cq-ink-mid)] leading-relaxed">
                Fill in the form and we&apos;ll get back to you within 24 hours with a free strategy consultation slot.
              </p>
            </div>

            <div className="flex flex-col font-body">
              <div className="border-b border-[var(--cq-linen)] py-4">
                <span className="block text-[10px] font-medium uppercase tracking-wider text-[var(--cq-ink-muted)] mb-1">
                  Email
                </span>
                <a
                  href="mailto:hello@creativequill.co.in"
                  className="text-sm font-medium text-[var(--cq-forest)] hover:text-[var(--cq-forest-hover)] transition-colors"
                >
              ...
              <div className="border-b border-[var(--cq-linen)] py-4">
                ...
                <span className="block text-[10px] text-[var(--cq-ink-faint)] mt-0.5">
              ...
              <div className="py-4">
                ...
                <span className="text-sm font-medium text-[var(--cq-ink)]">
                  Under 24 hours
                </span>
                <span className="block text-[10px] text-[var(--cq-ink-faint)] mt-0.5">
            ...
            <div className="border-l-2 border-[var(--cq-forest)] pl-4">
              <p className="font-display italic text-lg text-[var(--cq-ink-muted)] leading-relaxed">
          ...
          <div className="bg-[var(--cq-parchment)] border border-[var(--cq-linen)] rounded-[var(--radius-xl)] p-8 md:p-10 shadow-sm min-h-[480px] flex flex-col justify-between">
            {/* Step progress header */}
            <div className="flex items-center justify-between gap-4 mb-8">
              <span className="text-[10px] font-body tracking-wider uppercase text-[var(--cq-ink-muted)] font-medium">
                Project Inquiry
              </span>
              {!submitted && (
                <span className="font-body text-xs text-[var(--cq-ink-faint)] font-medium">
                  Step {step} of 5
                </span>
              )}
            </div>
                    ...
                    >
                                ...
                                <button
                                  ...
                                  className={`flex items-center gap-3 p-4 border rounded-[var(--radius-md)] text-left transition-all ${
                                    isSelected
                                      ...
                                      : "border-[var(--cq-linen)] bg-white text-[var(--cq-ink-mid)] hover:border-[var(--cq-linen)] hover:bg-[var(--cq-parchment-mid)]"
                                  }`}
                                  onClick={() => {
                      ...
                      {step === 4 && (
                        <div>
                          ...
                          <div className="flex flex-col gap-2">
                            <textarea
                              className="w-full min-h-[140px] bg-white border border-[var(--cq-linen)] focus:border-[var(--cq-forest)] rounded-[var(--radius-md)] p-4 outline-none text-base font-body text-[var(--cq-ink)] transition-colors resize-none"
                      ...
                      {step === 5 && (
                        <div>
                          ...
                          <div className="bg-[var(--cq-parchment-mid)] border border-[var(--cq-linen)] rounded-[var(--radius-xl)] p-6 flex flex-col gap-4 text-sm font-body">
                            <div className="border-b border-[var(--cq-linen)] pb-3">
            ...
            {!submitted && (
              step === 5 ? (
                ...
                <div className="flex items-center justify-between border-t border-[var(--cq-linen)] pt-6 mt-8">
                  {/* Left: Back + Edit */}
